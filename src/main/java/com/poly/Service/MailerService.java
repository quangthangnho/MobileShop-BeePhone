...
/**
 * Service này cung cấp phương thức gửi email
...
//	 * <li>BCC: các email ẩn danh cùng nhận, phân cách bởi dấu [,; ]</li>
//	 * <li>Attachment files: các file đính kèm, phân cách bởi dấu [,;]</li>
//	 * </ol>
...
//			if(from.length() == 0) {
//				from = "Poly Capstone Project <khaihcps10763@fpt.edu.vn>";
//			}
//			else {
