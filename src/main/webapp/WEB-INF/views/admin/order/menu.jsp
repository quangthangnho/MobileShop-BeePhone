...
<div id="myDIV">
	...
	<a href="/admin/order/choxacnhan" class="btn btn-primary" style="color: #fff; background-color:#43c801 " role="button">CHỜ XÁC NHẬN</a>
	<a href="/admin/order/cholayhang" class="btn btn-default" style="color: #fff;background-color: #ffc801" role="button">CHỜ LẤY HÀNG</a>
	<a href="/admin/order/danggiao" class="btn btn-secondary" style="color: #fff; background-color: #0072ab" role="button">ĐANG GIAO</a>
