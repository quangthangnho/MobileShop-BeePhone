...
<form:form action="/admin/customer/detail" modelAttribute="form" enctype="multipart/form-data">
<div class="panel panel-danger">
		...
		<div class="col-sm-3 text-center">
			...
			<div class="col-sm-8">
			    ...
			    <div class="form-group col-sm-3">
			        ...
			        <div class="form-control">
			        	<input type="radio" name="role" value="true" class="form-check-input"  >Yes
        				<input type="radio" name="role" value="false" class="form-check-input" checked="checked">No
			        </div>
			    </div> 
				</div>
			</div>
	...
	<div class="panel-footer">
		<c:choose>
			...
			<button formaction="/admin/customer/create" class="btn btn-success" title="Create">
			<i class="fa fa-plus-circle"></i> Create
		</button>
			</c:when>
			<c:when test="${!empty indexForm.getId()}">
			<button formaction="/admin/customer/create" class="btn btn-success" title="Create" disabled="disabled">
			<i class="fa fa-plus-circle"></i> Create
		</button>
			</c:when>
		</c:choose>
		...
		<button formaction="/admin/customer/delete" class="btn btn-danger" title="Delete">
			<i class="fa fa-trash-o"></i> Delete 
		</button>
		<button> <a href="/admin/customer/index" class="btn btn-info" title="Reset"> 
